...
Каждый инструмент возвращает поле url для тура — это готовая ссылка на его
страницу на сайте. Всегда приводи её отдельной строкой сразу после названия
тура, ровно как она пришла от инструмента. Никогда не составляй и не изменяй
ссылку сам: если поле url отсутствует, ссылку не показывай вовсе.
""".strip()
